    ...
    if not 'analisado' in folder:
        ...
        for img in list_img_files:
            ...
            if nome[-1] == ' ':
                ...
                i = -1
            if nome[i] == '8':
                dcm_file = path_to_dcm_file + '/' + 'G180C180.dcm'
                gantry = 180.0
                colimador = 180.0
            elif nome[i] == '7':
                dcm_file = path_to_dcm_file + '/' + 'G180C0.dcm'
                gantry = 180.0
                colimador = 0.0
            elif nome[i] == '6':
                dcm_file = path_to_dcm_file + '/' + 'G90C180.dcm'
                gantry = 90.0
                colimador = 180.0
            elif nome[i] == '5':
                dcm_file = path_to_dcm_file + '/' + 'G90C0.dcm'
                gantry = 90.0
                colimador = 0.0
            elif nome[i] == '4':
                dcm_file = path_to_dcm_file + '/' + 'G0C180.dcm'
                gantry = 0.0
                colimador = 180.0
            elif nome[i] == '3':
                dcm_file = path_to_dcm_file + '/' + 'G0C0.dcm'
                gantry = 0.0
                colimador = 0.0
            elif nome[i] == '2':
                dcm_file = path_to_dcm_file + '/' + 'G270C180.dcm'
                gantry = 270.0
                colimador = 180.0
            elif nome[i] == '1':
                dcm_file = path_to_dcm_file + '/' + 'G270C0.dcm'
                gantry = 270.0
                colimador = 0.0
