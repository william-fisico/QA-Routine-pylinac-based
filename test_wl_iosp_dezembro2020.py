...
lista_resultado = [['Data', 'Iso Gantry', 'Iso Colimador', 'Iso Gantry e Colimador', 'Iso Mesa',
                   'G0C0T0', 'G90C0T0', 'G180C0T0', 'G0C270T0', 'G270C0T0', 'G0C90T0', 'G0C180T0', 'G0C0T270', 'G0C0T90']]
root = './WL_IOSP_20201216'
#rename_wl(root)
...
for folder in root_folders:
    if not 'analisado' in folder:
        ...
        try:
            ...
            error_list = {i: 0.0 for i in range(1,10)}
            ...
            for axis in axis_list:
                ...
                for field_image in field_image_list[-1]:
                    ...
                    if axis[0]=='Gantry':
                        ...
                        elif field_image.collimator_angle==180:
                            error_list[7] = max_num
                    elif axis[0]=='Couch':
                        if field_image.couch_angle==90:
                            error_list[9] = max_num
